          ...
          <div className="mb-2 relative">
            ...
            {onImageRemove && (
              <button
                ...
                className={`absolute top-0 left-0 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity shadow-lg border-2 border-white`}
                title="Remove image"
              >
                ×
              </button>
